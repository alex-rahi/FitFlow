...
export const PLACEHOLDER_WORKOUT_FORMS = [
  {
    ...
    topics: ['workouts'],
    caption: 'Back squat — depth and knee tracking',
    workout_form: {
      exercise: 'Back squat',
      focus_points: ['Knees track over toes', 'Depth below parallel', 'Neutral spine at the bottom'],
      notes: 'Feels like I fold forward coming out of the hole.',
  ...
  },
  {
    ...
    media_type: 'form' as const,
    topics: ['workouts'],
    caption: 'Conventional deadlift — lockout and bar path',
    workout_form: {
      exercise: 'Conventional deadlift',
      focus_points: ['Hips and shoulders rise together', 'Bar stays close to shins', 'No hyperextension at lockout'],
      notes: 'Working up to heavy singles — 405 in the clip.',
      request_feedback: true,
    },
    thumbnail_url: null,
    status: 'published',
  ...
  },
  {
    ...
    media_type: 'form' as const,
    topics: ['workouts'],
    caption: 'Bench press — bar path and leg drive',
    workout_form: {
      exercise: 'Bench press',
      focus_points: ['Scapular retraction', 'Bar touches lower chest', 'Feet driving into the floor'],
      request_feedback: true,
    },
    thumbnail_url: null,
    status: 'published',
