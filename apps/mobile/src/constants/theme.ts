...
export const PLACEHOLDER_WORKOUT_FORMS = [
  {
    id: '10000000-0000-4000-8000-000000000010',
    user_id: '00000000-0000-4000-8000-000000000002',
    category: 'workouts',
    media_type: 'form' as const,
    caption: 'Leg day — 20 set quad focus',
    workout_form: {
      title: 'Leg day — quad focus',
      entries: [
        { exercise: 'Back squat', sets: '5', reps: '5', weight: '315 lb' },
        { exercise: 'Leg press', sets: '4', reps: '12', weight: '540 lb' },
        { exercise: 'Walking lunges', sets: '3', reps: '20', weight: '50 lb DBs' },
      ],
      notes: 'Paused last rep on every squat set.',
    },
    thumbnail_url: null,
    status: 'published',
    like_count: 640,
  ...
  },
  {
    ...
    category: 'prs',
    media_type: 'form' as const,
    caption: 'Bench PR block — 315 for 1',
    workout_form: {
      title: 'Bench PR day',
      entries: [
        { exercise: 'Bench press', sets: '1', reps: '1', weight: '315 lb' },
        { exercise: 'Close-grip bench', sets: '3', reps: '8', weight: '225 lb' },
        { exercise: 'Tricep pushdown', sets: '3', reps: '15', weight: '80 lb' },
      ],
      notes: '6 months of 5×5 paid off.',
    },
    thumbnail_url: null,
    status: 'published',
    like_count: 512,
  ...
  },
  {
    ...
    media_type: 'form' as const,
    topics: ['workouts'],
    caption: 'Push day — heavy OHP',
    workout_form: {
      title: 'Push day',
      entries: [
        { exercise: 'Overhead press', sets: '5', reps: '5', weight: '155 lb' },
        { exercise: 'Incline DB press', sets: '4', reps: '10', weight: '70 lb' },
        { exercise: 'Lateral raise', sets: '4', reps: '15', weight: '20 lb' },
      ],
    },
    thumbnail_url: null,
    status: 'published',
