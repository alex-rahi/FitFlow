  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      <View style={styles.header}>
        ...
        <Text style={styles.subtitle}>Training tips, form checks, and gear talk</Text>
      </View>
      {loading ? (
        ...
        <View style={styles.center}>
          ...
          <Text style={styles.emptySubtitle}>Start a discussion from Upload → Community thread</Text>
        </View>
      ) : (
        <ThreadFeedLayout
          posts={posts}
